...
class PresetsEditSettingWidget(SettingsTabBase):
    ...
    def __init__(self):
        ...
        self.lw_directory = QtWidgets.QListWidget()
        self.lw_directory.setMaximumHeight(100)

        self.pb_add = QtWidgets.QPushButton(QtGui.QIcon(":/add.png"), "")
        self.pb_remove = QtWidgets.QPushButton(QtGui.QIcon(":/remove.png"), "")
        self.pb_browse = QtWidgets.QPushButton(QtGui.QIcon(":/folder.png"), "")
        self.pb_reset = QtWidgets.QPushButton(QtGui.QIcon(":/reset.png"), "")
        ...
        layout.addWidget(QtWidgets.QLabel("Additionnal presets directory:"))
    ...
    def _browse(self, starting_dir=None):
        directory = QtWidgets.QFileDialog.getExistingDirectory(self, "Select presets folder", starting_dir)
        if directory:
            if os.name == 'nt':
